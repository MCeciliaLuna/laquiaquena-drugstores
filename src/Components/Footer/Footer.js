      ...
      <div className="py-3 px-0 d-flex justify-content-center align-items-center">
        <div className="ps-0 ms-0">
          <svg
            ...
            height="40"
            fill="currentColor"
            className="m-3 text-light bi bi-geo-alt-fill"
            viewBox="0 0 16 16"
          >
            <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
          </svg>
          <h3 className="text-light text-contacto">
            San Miguel de Tucumán, Tucumán, Argentina
          </h3>
          <h3 className="text-light text-contacto">
            Pcia. de Mendoza 2498 (Central)
          </h3>
          ...
          <svg
            ...
            height="40"
            fill="currentColor"
            className="text-center m-3 text-light bi bi-telephone-fill"
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
          ...
          <br />
          <a
            href="tel:+543816613960"
            className="text-light f-3 text-contacto d-block"
          >
            <h3>381 6613960</h3>
          </a>
        </div>
