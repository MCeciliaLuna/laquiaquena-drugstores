...
const LinksCategoriasAdmin = ({ setSelectedCategory }) => {
  ...
  return (
    ...
    <a href="#" className="text-light my-0 mx-2 link-admin-categoria" value="Hoja de Coca" onClick={() => setSelectedCategory('Hoja de Coca')}><h3>Hoja de Coca</h3></a>
    <a href="#" className="text-light my-0 mx-2 link-admin-categoria" value="Bico saborizados" onClick={() => setSelectedCategory('Bico saborizados')}><h3>Bico saborizados</h3></a>
      </div>
  );
};
