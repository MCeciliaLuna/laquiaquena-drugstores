  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/productos"
          element={<UserProductos setPedido={setPedido} pedido={pedido} />}
        />
        <Route
          path="/mipedido"
          element={<MiPedido setPedido={setPedido} pedido={pedido} />}
        />
        ...
        <Route
          path="/administrador/MendozaCentral"
          element={<AdminDrugstore1 />}
        />
